...
class Game():
    ...
    def findItem(self):
        ...
        if self.hasWalkedForward == False:
            print("You find nothing in the empty forest that you have already scoured.")
        else:
            if rand.random() > 0.5:
